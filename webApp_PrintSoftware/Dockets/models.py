...
class Docket(models.Model): #contains all the data for a docket to be stored in the database
    ...
    machine_1 = MultiSelectField(choices = list(Machine.objects.all().values_list("name", "name")), max_length = 100, null = True)
    ...
    machine_2 = MultiSelectField(choices = list(Machine.objects.all().values_list("name", "name")), blank = True, max_length=100, null = True)
    ...
    machine_3 = MultiSelectField(choices = list(Machine.objects.all().values_list("name", "name")), blank = True, max_length = 100, null= True)
