...
class Docket(models.Model): #contains all the data for a docket to be stored in the database
    ...
    inks_1 = models.CharField(max_length = 100, blank = True)
    ...
    stock_2 = models.CharField(max_length = 100, null = True, blank = True)
    ...
    inks_2 = models.CharField(max_length = 100, null = True, blank = True)
    ...
    stock_3 = models.CharField(max_length = 100, null = True, blank = True)
    ...
    inks_3 = models.CharField(max_length = 100, null = True, blank = True)
