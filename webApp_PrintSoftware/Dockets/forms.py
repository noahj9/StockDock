...
from .models import Docket, Stock
...
class NewDocketForm(ModelForm): #model form for new docket
    ...
    class Meta:
        ...
        widgets = { #allows utilization of bootstrap form controls and styling
            ...
            'proof_1': forms.Select(attrs={'class':'form-control'}),
            'inks_1': forms.Select(attrs={'class':'form-control'}),
            ...
            'stock_2': forms.Select(attrs={'class':'form-control'}),
            ...
            'proof_2': forms.Select(attrs={'class':'form-control'}),
            'inks_2': forms.Select(attrs={'class':'form-control'}),
            ...
            'stock_3': forms.Select(attrs={'class':'form-control'}),
            ...
            'proof_3': forms.Select(attrs={'class':'form-control'}),
            'inks_3': forms.Select(attrs={'class':'form-control'}),
