...
def updateSubCats(req):
    ...
    # Use get_object_or_404 to prevent unhandled DoesNotExist exception
    # Returns 404 instead of 500 error if contact doesn't exist, preventing cascading failures
...
def updateDocket(request, pk):
    # Use get_object_or_404 to handle missing docket gracefully
...
def printDocket(req, pk):
    # Use get_object_or_404 to handle missing docket/contact gracefully
    docket = get_object_or_404(Docket, id=pk)
