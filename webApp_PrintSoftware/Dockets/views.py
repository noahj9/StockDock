...
def updateDocket(request, pk):
    # Use get_object_or_404 to return 404 instead of 500 error when docket doesn't exist
...
def printDocket(req, pk):
    # Use get_object_or_404 to return 404 instead of 500 error when docket doesn't exist
    docket = get_object_or_404(Docket, id=pk)
    # Use get_object_or_404 to return 404 instead of 500 error when contact doesn't exist
