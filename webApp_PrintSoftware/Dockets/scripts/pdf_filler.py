...
def execute(docket,contact):
    res =['',docket.get("date").strftime("%Y-%m-%d"),docket.get("date_required").strftime("%Y-%m-%d"),docket.get("customer_name__name"),contact.get("name"),contact.get("phone"),contact.get("email"),
